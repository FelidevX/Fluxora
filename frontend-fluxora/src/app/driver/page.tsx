...
export default function DriverHomePage() {
  ...
  const fetchRutaOptimizada = async () => {
    try {
      ...
      const rutaResponse = await fetch(
        `${API_BASE_URL}/api/entregas/rutas/driver/${userData.sub}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/entregas/rutas/optimized-ortools/${rutaId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleObtenerProgramacion = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/entregas/entrega/programacion/${rutaId}/${today}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      alert(
        "Hubo un error al obtener la programación. Por favor, inténtelo de nuevo."
      );
    }
  };
  ...
  const handleIniciarRuta = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/entregas/rutas/iniciar/${rutaId}`,
        {
          method: "POST",
          headers: {
