...
const items: Item[] = [
  ...
  { href: '/dashboard/clientes-rutas', label: 'Clientes y Rutas', icon: 'groups' },
  { href: '/dashboard/prediccion', label: 'Predicción', icon: 'trending_up' },
  { href: '/dashboard/facturacion', label: 'Facturación', icon: 'receipt_long' },
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2 px-4 h-16 border-b border-white/10">
          <MaterialIcon name="business" className="text-white text-2xl" />
              ...
              return (
                <li key={item.href}>
                  <Link
                    ...
                    className={classes}
                  >
                    <MaterialIcon name={item.icon} className="text-xl opacity-90" />
